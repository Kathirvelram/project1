...
class Gsender
{
    ...
    private:
        ...
        const char* EMAIL_LOGIN = "kathir19549@gmail.com"; //sender's gmail ID
        const char* EMAIL_PASSWORD = "kathirvel2002"; //sender's gmail account's password
        const char* FROM = "kathir19549@gmail.com"; // sender's gmail ID
        /*------------------------------------------------------*/
