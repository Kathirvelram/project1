...
const char* ssid = "Hello";                      // WIFI network name
const char* password = "kathirvel";              // WIFI network password
/*--------------------------------------------------*/
...
void CustomInfo(){ // function to set custom settings
  ...
  recipientID = (String)"kathirvelramakrishnan@gmail.com"; // enter the email ID of the recipient
  subject = (String)"hello!!"; // enter the subject of the email
  body = (String)"notification"; // enter the body of the email
  /*--------------------------------------------------------------*/
}
